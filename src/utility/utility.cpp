...
#define WM_GETDPISCALEDSIZE         0x02E4
  ...
  //case WM_IMEKEYUP: return "WM_IMEKEYUP";
    ...
    // This is a huge block of window messages that are either
    //   undefined or duplicates of one another, so exclude all
    //     of them by default.
#if 0
    ...
    case DDM_SETFMT: return "DDM_SETFMT";
    case DM_GETDEFID: return "DM_GETDEFID";
    case NIN_SELECT: return "NIN_SELECT";
    case TBM_GETPOS: return "TBM_GETPOS";
    case WM_PSD_PAGESETUPDLG: return "WM_PSD_PAGESETUPDLG";
    case WM_USER: return "WM_USER";
    case CBEM_INSERTITEMA: return "CBEM_INSERTITEMA";
    case DDM_DRAW: return "DDM_DRAW";
    case DM_SETDEFID: return "DM_SETDEFID";
    case HKM_SETHOTKEY: return "HKM_SETHOTKEY";
    case PBM_SETRANGE: return "PBM_SETRANGE";
    case RB_INSERTBANDA: return "RB_INSERTBANDA";
    case SB_SETTEXTA: return "SB_SETTEXTA";
    case TB_ENABLEBUTTON: return "TB_ENABLEBUTTON";
    case TBM_GETRANGEMIN: return "TBM_GETRANGEMIN";
    case TTM_ACTIVATE: return "TTM_ACTIVATE";
    case WM_CHOOSEFONT_GETLOGFONT: return "WM_CHOOSEFONT_GETLOGFONT";
    case WM_PSD_FULLPAGERECT: return "WM_PSD_FULLPAGERECT";
    case CBEM_SETIMAGELIST: return "CBEM_SETIMAGELIST";
    case DDM_CLOSE: return "DDM_CLOSE";
    case DM_REPOSITION: return "DM_REPOSITION";
    case HKM_GETHOTKEY: return "HKM_GETHOTKEY";
    case PBM_SETPOS: return "PBM_SETPOS";
    case RB_DELETEBAND: return "RB_DELETEBAND";
    case SB_GETTEXTA: return "SB_GETTEXTA";
    case TB_CHECKBUTTON: return "TB_CHECKBUTTON";
    case TBM_GETRANGEMAX: return "TBM_GETRANGEMAX";
    case WM_PSD_MINMARGINRECT: return "WM_PSD_MINMARGINRECT";
    case CBEM_GETIMAGELIST: return "CBEM_GETIMAGELIST";
    case DDM_BEGIN: return "DDM_BEGIN";
    case HKM_SETRULES: return "HKM_SETRULES";
    case PBM_DELTAPOS: return "PBM_DELTAPOS";
    case RB_GETBARINFO: return "RB_GETBARINFO";
    case SB_GETTEXTLENGTHA: return "SB_GETTEXTLENGTHA";
    case TBM_GETTIC: return "TBM_GETTIC";
    case TB_PRESSBUTTON: return "TB_PRESSBUTTON";
    case TTM_SETDELAYTIME: return "TTM_SETDELAYTIME";
    case WM_PSD_MARGINRECT: return "WM_PSD_MARGINRECT";
    case CBEM_GETITEMA: return "CBEM_GETITEMA";
    case DDM_END: return "DDM_END";
    case PBM_SETSTEP: return "PBM_SETSTEP";
    case RB_SETBARINFO: return "RB_SETBARINFO";
    case SB_SETPARTS: return "SB_SETPARTS";
    case TB_HIDEBUTTON: return "TB_HIDEBUTTON";
    case TBM_SETTIC: return "TBM_SETTIC";
    case TTM_ADDTOOLA: return "TTM_ADDTOOLA";
    case WM_PSD_GREEKTEXTRECT: return "WM_PSD_GREEKTEXTRECT";
    case CBEM_SETITEMA: return "CBEM_SETITEMA";
    case PBM_STEPIT: return "PBM_STEPIT";
    case TB_INDETERMINATE: return "TB_INDETERMINATE";
    case TBM_SETPOS: return "TBM_SETPOS";
    case TTM_DELTOOLA: return "TTM_DELTOOLA";
    case WM_PSD_ENVSTAMPRECT: return "WM_PSD_ENVSTAMPRECT";
    case CBEM_GETCOMBOCONTROL: return "CBEM_GETCOMBOCONTROL";
    case PBM_SETRANGE32: return "PBM_SETRANGE32";
    case RB_SETBANDINFOA: return "RB_SETBANDINFOA";
    case SB_GETPARTS: return "SB_GETPARTS";
    case TB_MARKBUTTON: return "TB_MARKBUTTON";
    case TBM_SETRANGE: return "TBM_SETRANGE";
    case TTM_NEWTOOLRECTA: return "TTM_NEWTOOLRECTA";
    case WM_PSD_YAFULLPAGERECT: return "WM_PSD_YAFULLPAGERECT";
    case CBEM_GETEDITCONTROL: return "CBEM_GETEDITCONTROL";
    case PBM_GETRANGE: return "PBM_GETRANGE";
    case RB_SETPARENT: return "RB_SETPARENT";
    case SB_GETBORDERS: return "SB_GETBORDERS";
    case TBM_SETRANGEMIN: return "TBM_SETRANGEMIN";
    case TTM_RELAYEVENT: return "TTM_RELAYEVENT";
    case CBEM_SETEXSTYLE: return "CBEM_SETEXSTYLE";
    case PBM_GETPOS: return "PBM_GETPOS";
    case RB_HITTEST: return "RB_HITTEST";
    case SB_SETMINHEIGHT: return "SB_SETMINHEIGHT";
    case TBM_SETRANGEMAX: return "TBM_SETRANGEMAX";
    case TTM_GETTOOLINFOA: return "TTM_GETTOOLINFOA";
    case CBEM_GETEXSTYLE: return "CBEM_GETEXSTYLE";
    case CBEM_GETEXTENDEDSTYLE: return "CBEM_GETEXTENDEDSTYLE";
    case PBM_SETBARCOLOR: return "PBM_SETBARCOLOR";
    case RB_GETRECT: return "RB_GETRECT";
    case SB_SIMPLE: return "SB_SIMPLE";
    case TB_ISBUTTONENABLED: return "TB_ISBUTTONENABLED";
    case TBM_CLEARTICS: return "TBM_CLEARTICS";
    case TTM_SETTOOLINFOA: return "TTM_SETTOOLINFOA";
    case CBEM_HASEDITCHANGED: return "CBEM_HASEDITCHANGED";
    case RB_INSERTBANDW: return "RB_INSERTBANDW";
    case SB_GETRECT: return "SB_GETRECT";
    case TB_ISBUTTONCHECKED: return "TB_ISBUTTONCHECKED";
    case TBM_SETSEL: return "TBM_SETSEL";
    case TTM_HITTESTA: return "TTM_HITTESTA";
    case WIZ_QUERYNUMPAGES: return "WIZ_QUERYNUMPAGES";
    case CBEM_INSERTITEMW: return "CBEM_INSERTITEMW";
    case RB_SETBANDINFOW: return "RB_SETBANDINFOW";
    case SB_SETTEXTW: return "SB_SETTEXTW";
    case TB_ISBUTTONPRESSED: return "TB_ISBUTTONPRESSED";
    case TBM_SETSELSTART: return "TBM_SETSELSTART";
    case TTM_GETTEXTA: return "TTM_GETTEXTA";
    case WIZ_NEXT: return "WIZ_NEXT";
    case CBEM_SETITEMW: return "CBEM_SETITEMW";
    case RB_GETBANDCOUNT: return "RB_GETBANDCOUNT";
    case SB_GETTEXTLENGTHW: return "SB_GETTEXTLENGTHW";
    case TB_ISBUTTONHIDDEN: return "TB_ISBUTTONHIDDEN";
    case TBM_SETSELEND: return "TBM_SETSELEND";
    case TTM_UPDATETIPTEXTA: return "TTM_UPDATETIPTEXTA";
    case WIZ_PREV: return "WIZ_PREV";
    case CBEM_GETITEMW: return "CBEM_GETITEMW";
    case RB_GETROWCOUNT: return "RB_GETROWCOUNT";
    case SB_GETTEXTW: return "SB_GETTEXTW";
    case TB_ISBUTTONINDETERMINATE: return "TB_ISBUTTONINDETERMINATE";
    case TTM_GETTOOLCOUNT: return "TTM_GETTOOLCOUNT";
    case CBEM_SETEXTENDEDSTYLE: return "CBEM_SETEXTENDEDSTYLE";
    case RB_GETROWHEIGHT: return "RB_GETROWHEIGHT";
    case SB_ISSIMPLE: return "SB_ISSIMPLE";
    case TB_ISBUTTONHIGHLIGHTED: return "TB_ISBUTTONHIGHLIGHTED";
    case TBM_GETPTICS: return "TBM_GETPTICS";
    case TTM_ENUMTOOLSA: return "TTM_ENUMTOOLSA";
    case SB_SETICON: return "SB_SETICON";
    case TBM_GETTICPOS: return "TBM_GETTICPOS";
    case TTM_GETCURRENTTOOLA: return "TTM_GETCURRENTTOOLA";
    case RB_IDTOINDEX: return "RB_IDTOINDEX";
    case SB_SETTIPTEXTA: return "SB_SETTIPTEXTA";
    case TBM_GETNUMTICS: return "TBM_GETNUMTICS";
    case TTM_WINDOWFROMPOINT: return "TTM_WINDOWFROMPOINT";
    case RB_GETTOOLTIPS: return "RB_GETTOOLTIPS";
    case SB_SETTIPTEXTW: return "SB_SETTIPTEXTW";
    case TBM_GETSELSTART: return "TBM_GETSELSTART";
    case TB_SETSTATE: return "TB_SETSTATE";
    case TTM_TRACKACTIVATE: return "TTM_TRACKACTIVATE";
    case RB_SETTOOLTIPS: return "RB_SETTOOLTIPS";
    case SB_GETTIPTEXTA: return "SB_GETTIPTEXTA";
    case TB_GETSTATE: return "TB_GETSTATE";
    case TBM_GETSELEND: return "TBM_GETSELEND";
    case TTM_TRACKPOSITION: return "TTM_TRACKPOSITION";
    case RB_SETBKCOLOR: return "RB_SETBKCOLOR";
    case SB_GETTIPTEXTW: return "SB_GETTIPTEXTW";
    case TB_ADDBITMAP: return "TB_ADDBITMAP";
    case TBM_CLEARSEL: return "TBM_CLEARSEL";
    case TTM_SETTIPBKCOLOR: return "TTM_SETTIPBKCOLOR";
    case RB_GETBKCOLOR: return "RB_GETBKCOLOR";
    case SB_GETICON: return "SB_GETICON";
    case TB_ADDBUTTONSA: return "TB_ADDBUTTONSA";
    case TBM_SETTICFREQ: return "TBM_SETTICFREQ";
    case TTM_SETTIPTEXTCOLOR: return "TTM_SETTIPTEXTCOLOR";
    case RB_SETTEXTCOLOR: return "RB_SETTEXTCOLOR";
    case TB_INSERTBUTTONA: return "TB_INSERTBUTTONA";
    case TBM_SETPAGESIZE: return "TBM_SETPAGESIZE";
    case TTM_GETDELAYTIME: return "TTM_GETDELAYTIME";
    case RB_GETTEXTCOLOR: return "RB_GETTEXTCOLOR";
    case TB_DELETEBUTTON: return "TB_DELETEBUTTON";
    case TBM_GETPAGESIZE: return "TBM_GETPAGESIZE";
    case TTM_GETTIPBKCOLOR: return "TTM_GETTIPBKCOLOR";
    case RB_SIZETORECT: return "RB_SIZETORECT";
    case TB_GETBUTTON: return "TB_GETBUTTON";
    case TBM_SETLINESIZE: return "TBM_SETLINESIZE";
    case TTM_GETTIPTEXTCOLOR: return "TTM_GETTIPTEXTCOLOR";
    case RB_BEGINDRAG: return "RB_BEGINDRAG";
    case TB_BUTTONCOUNT: return "TB_BUTTONCOUNT";
    case TBM_GETLINESIZE: return "TBM_GETLINESIZE";
    case TTM_SETMAXTIPWIDTH: return "TTM_SETMAXTIPWIDTH";
    case RB_ENDDRAG: return "RB_ENDDRAG";
    case TB_COMMANDTOINDEX: return "TB_COMMANDTOINDEX";
    case TBM_GETTHUMBRECT: return "TBM_GETTHUMBRECT";
    case TTM_GETMAXTIPWIDTH: return "TTM_GETMAXTIPWIDTH";
    case RB_DRAGMOVE: return "RB_DRAGMOVE";
    case TBM_GETCHANNELRECT: return "TBM_GETCHANNELRECT";
    case TB_SAVERESTOREA: return "TB_SAVERESTOREA";
    case TTM_SETMARGIN: return "TTM_SETMARGIN";
    case RB_GETBARHEIGHT: return "RB_GETBARHEIGHT";
    case TB_CUSTOMIZE: return "TB_CUSTOMIZE";
    case TBM_SETTHUMBLENGTH: return "TBM_SETTHUMBLENGTH";
    case TTM_GETMARGIN: return "TTM_GETMARGIN";
    case RB_GETBANDINFOW: return "RB_GETBANDINFOW";
    case TB_ADDSTRINGA: return "TB_ADDSTRINGA";
    case TBM_GETTHUMBLENGTH: return "TBM_GETTHUMBLENGTH";
    case TTM_POP: return "TTM_POP";
    case RB_GETBANDINFOA: return "RB_GETBANDINFOA";
    case TB_GETITEMRECT: return "TB_GETITEMRECT";
    case TBM_SETTOOLTIPS: return "TBM_SETTOOLTIPS";
    case TTM_UPDATE: return "TTM_UPDATE";
    case RB_MINIMIZEBAND: return "RB_MINIMIZEBAND";
    case TB_BUTTONSTRUCTSIZE: return "TB_BUTTONSTRUCTSIZE";
    case TBM_GETTOOLTIPS: return "TBM_GETTOOLTIPS";
    case TTM_GETBUBBLESIZE: return "TTM_GETBUBBLESIZE";
    case RB_MAXIMIZEBAND: return "RB_MAXIMIZEBAND";
    case TBM_SETTIPSIDE: return "TBM_SETTIPSIDE";
    case TB_SETBUTTONSIZE: return "TB_SETBUTTONSIZE";
    case TTM_ADJUSTRECT: return "TTM_ADJUSTRECT";
    case TBM_SETBUDDY: return "TBM_SETBUDDY";
    case TB_SETBITMAPSIZE: return "TB_SETBITMAPSIZE";
    case TTM_SETTITLEA: return "TTM_SETTITLEA";
    case MSG_FTS_JUMP_VA: return "MSG_FTS_JUMP_VA";
    case TB_AUTOSIZE: return "TB_AUTOSIZE";
    case TBM_GETBUDDY: return "TBM_GETBUDDY";
    case TTM_SETTITLEW: return "TTM_SETTITLEW";
    case RB_GETBANDBORDERS: return "RB_GETBANDBORDERS";
    case MSG_FTS_JUMP_QWORD: return "MSG_FTS_JUMP_QWORD";
    case RB_SHOWBAND: return "RB_SHOWBAND";
    case TB_GETTOOLTIPS: return "TB_GETTOOLTIPS";
    case MSG_REINDEX_REQUEST: return "MSG_REINDEX_REQUEST";
    case TB_SETTOOLTIPS: return "TB_SETTOOLTIPS";
    case MSG_FTS_WHERE_IS_IT: return "MSG_FTS_WHERE_IS_IT";
    case RB_SETPALETTE: return "RB_SETPALETTE";
    case TB_SETPARENT: return "TB_SETPARENT";
    case RB_GETPALETTE: return "RB_GETPALETTE";
    case RB_MOVEBAND: return "RB_MOVEBAND";
    case TB_SETROWS: return "TB_SETROWS";
    ...
    case TB_CHANGEBITMAP: return "TB_CHANGEBITMAP";
    case TB_GETBITMAP: return "TB_GETBITMAP";
    case MSG_GET_DEFFONT: return "MSG_GET_DEFFONT";
    ...
    case EM_CANPASTE: return "EM_CANPASTE";
    case TTM_ADDTOOLW: return "TTM_ADDTOOLW";
    case EM_DISPLAYBAND: return "EM_DISPLAYBAND";
    case TB_GETRECT: return "TB_GETRECT";
    case TTM_DELTOOLW: return "TTM_DELTOOLW";
    case EM_EXGETSEL: return "EM_EXGETSEL";
    case TB_SETHOTIMAGELIST: return "TB_SETHOTIMAGELIST";
    case TTM_NEWTOOLRECTW: return "TTM_NEWTOOLRECTW";
    case EM_EXLIMITTEXT: return "EM_EXLIMITTEXT";
    case TB_GETHOTIMAGELIST: return "TB_GETHOTIMAGELIST";
    case TTM_GETTOOLINFOW: return "TTM_GETTOOLINFOW";
    case EM_EXLINEFROMCHAR: return "EM_EXLINEFROMCHAR";
    case TB_SETDISABLEDIMAGELIST: return "TB_SETDISABLEDIMAGELIST";
    case TTM_SETTOOLINFOW: return "TTM_SETTOOLINFOW";
    case EM_EXSETSEL: return "EM_EXSETSEL";
    case TB_GETDISABLEDIMAGELIST: return "TB_GETDISABLEDIMAGELIST";
    case TTM_HITTESTW: return "TTM_HITTESTW";
    case EM_FINDTEXT: return "EM_FINDTEXT";
    case TB_SETSTYLE: return "TB_SETSTYLE";
    case TTM_GETTEXTW: return "TTM_GETTEXTW";
    case EM_FORMATRANGE: return "EM_FORMATRANGE";
    case TB_GETSTYLE: return "TB_GETSTYLE";
    case TTM_UPDATETIPTEXTW: return "TTM_UPDATETIPTEXTW";
    case EM_GETCHARFORMAT: return "EM_GETCHARFORMAT";
    case TB_GETBUTTONSIZE: return "TB_GETBUTTONSIZE";
    case TTM_ENUMTOOLSW: return "TTM_ENUMTOOLSW";
    case EM_GETEVENTMASK: return "EM_GETEVENTMASK";
    case TB_SETBUTTONWIDTH: return "TB_SETBUTTONWIDTH";
    case TTM_GETCURRENTTOOLW: return "TTM_GETCURRENTTOOLW";
    case EM_GETOLEINTERFACE: return "EM_GETOLEINTERFACE";
    case TB_SETMAXTEXTROWS: return "TB_SETMAXTEXTROWS";
    case EM_GETPARAFORMAT: return "EM_GETPARAFORMAT";
    case TB_GETTEXTROWS: return "TB_GETTEXTROWS";
    case EM_GETSELTEXT: return "EM_GETSELTEXT";
    case TB_GETOBJECT: return "TB_GETOBJECT";
    case EM_HIDESELECTION: return "EM_HIDESELECTION";
    case TB_GETBUTTONINFOW: return "TB_GETBUTTONINFOW";
    case EM_PASTESPECIAL: return "EM_PASTESPECIAL";
    case TB_SETBUTTONINFOW: return "TB_SETBUTTONINFOW";
    case EM_REQUESTRESIZE: return "EM_REQUESTRESIZE";
    case TB_GETBUTTONINFOA: return "TB_GETBUTTONINFOA";
    case EM_SELECTIONTYPE: return "EM_SELECTIONTYPE";
    case TB_SETBUTTONINFOA: return "TB_SETBUTTONINFOA";
    case EM_SETBKGNDCOLOR: return "EM_SETBKGNDCOLOR";
    case TB_INSERTBUTTONW: return "TB_INSERTBUTTONW";
    case EM_SETCHARFORMAT: return "EM_SETCHARFORMAT";
    case TB_ADDBUTTONSW: return "TB_ADDBUTTONSW";
    case EM_SETEVENTMASK: return "EM_SETEVENTMASK";
    case TB_HITTEST: return "TB_HITTEST";
    case EM_SETOLECALLBACK: return "EM_SETOLECALLBACK";
    case TB_SETDRAWTEXTFLAGS: return "TB_SETDRAWTEXTFLAGS";
    case EM_SETPARAFORMAT: return "EM_SETPARAFORMAT";
    case TB_GETHOTITEM: return "TB_GETHOTITEM";
    case EM_SETTARGETDEVICE: return "EM_SETTARGETDEVICE";
    case TB_SETHOTITEM: return "TB_SETHOTITEM";
    case EM_STREAMIN: return "EM_STREAMIN";
    case TB_SETANCHORHIGHLIGHT: return "TB_SETANCHORHIGHLIGHT";
    case EM_STREAMOUT: return "EM_STREAMOUT";
    case TB_GETANCHORHIGHLIGHT: return "TB_GETANCHORHIGHLIGHT";
    case EM_GETTEXTRANGE: return "EM_GETTEXTRANGE";
    case TB_GETBUTTONTEXTW: return "TB_GETBUTTONTEXTW";
    case EM_FINDWORDBREAK: return "EM_FINDWORDBREAK";
    case TB_SAVERESTOREW: return "TB_SAVERESTOREW";
    case EM_SETOPTIONS: return "EM_SETOPTIONS";
    case TB_ADDSTRINGW: return "TB_ADDSTRINGW";
    case EM_GETOPTIONS: return "EM_GETOPTIONS";
    case TB_MAPACCELERATORA: return "TB_MAPACCELERATORA";
    case EM_FINDTEXTEX: return "EM_FINDTEXTEX";
    case TB_GETINSERTMARK: return "TB_GETINSERTMARK";
    case EM_GETWORDBREAKPROCEX: return "EM_GETWORDBREAKPROCEX";
    case TB_SETINSERTMARK: return "TB_SETINSERTMARK";
    case EM_SETWORDBREAKPROCEX: return "EM_SETWORDBREAKPROCEX";
    case TB_INSERTMARKHITTEST: return "TB_INSERTMARKHITTEST";
    case EM_SETUNDOLIMIT: return "EM_SETUNDOLIMIT";
    case TB_MOVEBUTTON: return "TB_MOVEBUTTON";
    case TB_GETMAXSIZE: return "TB_GETMAXSIZE";
    case EM_REDO: return "EM_REDO";
    case TB_SETEXTENDEDSTYLE: return "TB_SETEXTENDEDSTYLE";
    case EM_CANREDO: return "EM_CANREDO";
    case TB_GETEXTENDEDSTYLE: return "TB_GETEXTENDEDSTYLE";
    case EM_GETUNDONAME: return "EM_GETUNDONAME";
    case TB_GETPADDING: return "TB_GETPADDING";
    case EM_GETREDONAME: return "EM_GETREDONAME";
    case TB_SETPADDING: return "TB_SETPADDING";
    case EM_STOPGROUPTYPING: return "EM_STOPGROUPTYPING";
    case TB_SETINSERTMARKCOLOR: return "TB_SETINSERTMARKCOLOR";
    case EM_SETTEXTMODE: return "EM_SETTEXTMODE";
    case TB_GETINSERTMARKCOLOR: return "TB_GETINSERTMARKCOLOR";
    case EM_GETTEXTMODE: return "EM_GETTEXTMODE";
    case TB_MAPACCELERATORW: return "TB_MAPACCELERATORW";
    case EM_AUTOURLDETECT: return "EM_AUTOURLDETECT";
    case TB_GETSTRINGW: return "TB_GETSTRINGW";
    case EM_GETAUTOURLDETECT: return "EM_GETAUTOURLDETECT";
    case TB_GETSTRINGA: return "TB_GETSTRINGA";
    case EM_SETPALETTE: return "EM_SETPALETTE";
    case EM_GETTEXTEX: return "EM_GETTEXTEX";
    case EM_GETTEXTLENGTHEX: return "EM_GETTEXTLENGTHEX";
    case EM_SHOWSCROLLBAR: return "EM_SHOWSCROLLBAR";
    case EM_SETTEXTEX: return "EM_SETTEXTEX";
    case TAPI_REPLY: return "TAPI_REPLY";
    case ACM_OPENA: return "ACM_OPENA";
    case BFFM_SETSTATUSTEXTA: return "BFFM_SETSTATUSTEXTA";
    case CDM_FIRST: return "CDM_FIRST";
    case CDM_GETSPEC: return "CDM_GETSPEC";
    case EM_SETPUNCTUATION: return "EM_SETPUNCTUATION";
    case IPM_CLEARADDRESS: return "IPM_CLEARADDRESS";
    case WM_CAP_UNICODE_START: return "WM_CAP_UNICODE_START";
    case ACM_PLAY: return "ACM_PLAY";
    case BFFM_ENABLEOK: return "BFFM_ENABLEOK";
    case CDM_GETFILEPATH: return "CDM_GETFILEPATH";
    case EM_GETPUNCTUATION: return "EM_GETPUNCTUATION";
    case IPM_SETADDRESS: return "IPM_SETADDRESS";
    case PSM_SETCURSEL: return "PSM_SETCURSEL";
    case UDM_SETRANGE: return "UDM_SETRANGE";
    case WM_CHOOSEFONT_SETLOGFONT: return "WM_CHOOSEFONT_SETLOGFONT";
    case ACM_STOP: return "ACM_STOP";
    case BFFM_SETSELECTIONA: return "BFFM_SETSELECTIONA";
    case CDM_GETFOLDERPATH: return "CDM_GETFOLDERPATH";
    case EM_SETWORDWRAPMODE: return "EM_SETWORDWRAPMODE";
    case IPM_GETADDRESS: return "IPM_GETADDRESS";
    case PSM_REMOVEPAGE: return "PSM_REMOVEPAGE";
    case UDM_GETRANGE: return "UDM_GETRANGE";
    case WM_CAP_SET_CALLBACK_ERRORW: return "WM_CAP_SET_CALLBACK_ERRORW";
    case WM_CHOOSEFONT_SETFLAGS: return "WM_CHOOSEFONT_SETFLAGS";
    case ACM_OPENW: return "ACM_OPENW";
    case BFFM_SETSELECTIONW: return "BFFM_SETSELECTIONW";
    case CDM_GETFOLDERIDLIST: return "CDM_GETFOLDERIDLIST";
    case EM_GETWORDWRAPMODE: return "EM_GETWORDWRAPMODE";
    case IPM_SETRANGE: return "IPM_SETRANGE";
    case PSM_ADDPAGE: return "PSM_ADDPAGE";
    case UDM_SETPOS: return "UDM_SETPOS";
    case WM_CAP_SET_CALLBACK_STATUSW: return "WM_CAP_SET_CALLBACK_STATUSW";
    case BFFM_SETSTATUSTEXTW: return "BFFM_SETSTATUSTEXTW";
    case CDM_SETCONTROLTEXT: return "CDM_SETCONTROLTEXT";
    case EM_SETIMECOLOR: return "EM_SETIMECOLOR";
    case IPM_SETFOCUS: return "IPM_SETFOCUS";
    case PSM_CHANGED: return "PSM_CHANGED";
    case UDM_GETPOS: return "UDM_GETPOS";
    case CDM_HIDECONTROL: return "CDM_HIDECONTROL";
    case EM_GETIMECOLOR: return "EM_GETIMECOLOR";
    case IPM_ISBLANK: return "IPM_ISBLANK";
    case PSM_RESTARTWINDOWS: return "PSM_RESTARTWINDOWS";
    case UDM_SETBUDDY: return "UDM_SETBUDDY";
    case CDM_SETDEFEXT: return "CDM_SETDEFEXT";
    case EM_SETIMEOPTIONS: return "EM_SETIMEOPTIONS";
    case PSM_REBOOTSYSTEM: return "PSM_REBOOTSYSTEM";
    case UDM_GETBUDDY: return "UDM_GETBUDDY";
    case EM_GETIMEOPTIONS: return "EM_GETIMEOPTIONS";
    case PSM_CANCELTOCLOSE: return "PSM_CANCELTOCLOSE";
    case UDM_SETACCEL: return "UDM_SETACCEL";
    case EM_CONVPOSITION: return "EM_CONVPOSITION";
    case EM_CONVPOSITION: return "EM_CONVPOSITION";
    case PSM_QUERYSIBLINGS: return "PSM_QUERYSIBLINGS";
    case UDM_GETACCEL: return "UDM_GETACCEL";
    case MCIWNDM_GETZOOM: return "MCIWNDM_GETZOOM";
    case PSM_UNCHANGED: return "PSM_UNCHANGED";
    case UDM_SETBASE: return "UDM_SETBASE";
    case PSM_APPLY: return "PSM_APPLY";
    case UDM_GETBASE: return "UDM_GETBASE";
    case PSM_SETTITLEA: return "PSM_SETTITLEA";
    case UDM_SETRANGE32: return "UDM_SETRANGE32";
    case PSM_SETWIZBUTTONS: return "PSM_SETWIZBUTTONS";
    case UDM_GETRANGE32: return "UDM_GETRANGE32";
    case WM_CAP_DRIVER_GET_NAMEW: return "WM_CAP_DRIVER_GET_NAMEW";
    case PSM_PRESSBUTTON: return "PSM_PRESSBUTTON";
    case UDM_SETPOS32: return "UDM_SETPOS32";
    case WM_CAP_DRIVER_GET_VERSIONW: return "WM_CAP_DRIVER_GET_VERSIONW";
    case PSM_SETCURSELID: return "PSM_SETCURSELID";
    case UDM_GETPOS32: return "UDM_GETPOS32";
    ...
    case MCIWNDM_REALIZE: return "MCIWNDM_REALIZE";
    case PSM_GETCURRENTPAGEHWND: return "PSM_GETCURRENTPAGEHWND";
    case MCIWNDM_SETTIMEFORMATA: return "MCIWNDM_SETTIMEFORMATA";
    case PSM_INSERTPAGE: return "PSM_INSERTPAGE";
    case EM_SETLANGOPTIONS: return "EM_SETLANGOPTIONS";
    case MCIWNDM_GETTIMEFORMATA: return "MCIWNDM_GETTIMEFORMATA";
    case PSM_SETTITLEW: return "PSM_SETTITLEW";
    case WM_CAP_FILE_SET_CAPTURE_FILEW: return "WM_CAP_FILE_SET_CAPTURE_FILEW";
    case EM_GETLANGOPTIONS: return "EM_GETLANGOPTIONS";
    case MCIWNDM_VALIDATEMEDIA: return "MCIWNDM_VALIDATEMEDIA";
    case PSM_SETFINISHTEXTW: return "PSM_SETFINISHTEXTW";
    case WM_CAP_FILE_GET_CAPTURE_FILEW: return "WM_CAP_FILE_GET_CAPTURE_FILEW";
    case EM_GETIMECOMPMODE: return "EM_GETIMECOMPMODE";
    case EM_FINDTEXTW: return "EM_FINDTEXTW";
    case MCIWNDM_PLAYTO: return "MCIWNDM_PLAYTO";
    case WM_CAP_FILE_SAVEASW: return "WM_CAP_FILE_SAVEASW";
    case EM_FINDTEXTEXW: return "EM_FINDTEXTEXW";
    case MCIWNDM_GETFILENAMEA: return "MCIWNDM_GETFILENAMEA";
    case EM_RECONVERSION: return "EM_RECONVERSION";
    case MCIWNDM_GETDEVICEA: return "MCIWNDM_GETDEVICEA";
    case PSM_SETHEADERTITLEA: return "PSM_SETHEADERTITLEA";
    case WM_CAP_FILE_SAVEDIBW: return "WM_CAP_FILE_SAVEDIBW";
    case EM_SETIMEMODEBIAS: return "EM_SETIMEMODEBIAS";
    case MCIWNDM_GETPALETTE: return "MCIWNDM_GETPALETTE";
    case PSM_SETHEADERTITLEW: return "PSM_SETHEADERTITLEW";
    case EM_GETIMEMODEBIAS: return "EM_GETIMEMODEBIAS";
    case MCIWNDM_SETPALETTE: return "MCIWNDM_SETPALETTE";
    case PSM_SETHEADERSUBTITLEA: return "PSM_SETHEADERSUBTITLEA";
    case MCIWNDM_GETERRORA: return "MCIWNDM_GETERRORA";
    ...
    case MCIWNDM_SETINACTIVETIMER: return "MCIWNDM_SETINACTIVETIMER";
    ...
    case MCIWNDM_GETINACTIVETIMER: return "MCIWNDM_GETINACTIVETIMER";
    ...
    case MCIWNDM_GET_SOURCE: return "MCIWNDM_GET_SOURCE";
    case MCIWNDM_PUT_SOURCE: return "MCIWNDM_PUT_SOURCE";
    case MCIWNDM_GET_DEST: return "MCIWNDM_GET_DEST";
    case MCIWNDM_PUT_DEST: return "MCIWNDM_PUT_DEST";
    case MCIWNDM_CAN_PLAY: return "MCIWNDM_CAN_PLAY";
    case MCIWNDM_CAN_WINDOW: return "MCIWNDM_CAN_WINDOW";
    case MCIWNDM_CAN_RECORD: return "MCIWNDM_CAN_RECORD";
    case MCIWNDM_CAN_SAVE: return "MCIWNDM_CAN_SAVE";
    case MCIWNDM_CAN_EJECT: return "MCIWNDM_CAN_EJECT";
    case MCIWNDM_CAN_CONFIG: return "MCIWNDM_CAN_CONFIG";
    case IE_GETINK: return "IE_GETINK";
    case IE_MSGFIRST: return "IE_MSGFIRST";
    case MCIWNDM_PALETTEKICK: return "MCIWNDM_PALETTEKICK";
    case IE_SETINK: return "IE_SETINK";
    case IE_GETPENTIP: return "IE_GETPENTIP";
    case IE_SETPENTIP: return "IE_SETPENTIP";
    case IE_GETERASERTIP: return "IE_GETERASERTIP";
    case IE_SETERASERTIP: return "IE_SETERASERTIP";
    case IE_GETBKGND: return "IE_GETBKGND";
    case IE_SETBKGND: return "IE_SETBKGND";
    case IE_GETGRIDORIGIN: return "IE_GETGRIDORIGIN";
    case IE_SETGRIDORIGIN: return "IE_SETGRIDORIGIN";
    case IE_GETGRIDPEN: return "IE_GETGRIDPEN";
    case IE_SETGRIDPEN: return "IE_SETGRIDPEN";
    case IE_GETGRIDSIZE: return "IE_GETGRIDSIZE";
    case IE_SETGRIDSIZE: return "IE_SETGRIDSIZE";
    case IE_GETMODE: return "IE_GETMODE";
    case IE_SETMODE: return "IE_SETMODE";
    case IE_GETINKRECT: return "IE_GETINKRECT";
    case WM_CAP_SET_MCI_DEVICEW: return "WM_CAP_SET_MCI_DEVICEW";
    case WM_CAP_GET_MCI_DEVICEW: return "WM_CAP_GET_MCI_DEVICEW";
    case WM_CAP_PAL_OPENW: return "WM_CAP_PAL_OPENW";
    case WM_CAP_PAL_SAVEW: return "WM_CAP_PAL_SAVEW";
    case IE_GETAPPDATA: return "IE_GETAPPDATA";
    case IE_SETAPPDATA: return "IE_SETAPPDATA";
    case IE_GETDRAWOPTS: return "IE_GETDRAWOPTS";
    case IE_SETDRAWOPTS: return "IE_SETDRAWOPTS";
    case IE_GETFORMAT: return "IE_GETFORMAT";
    case IE_SETFORMAT: return "IE_SETFORMAT";
    case IE_GETINKINPUT: return "IE_GETINKINPUT";
    case IE_SETINKINPUT: return "IE_SETINKINPUT";
    case IE_GETNOTIFY: return "IE_GETNOTIFY";
    case IE_SETNOTIFY: return "IE_SETNOTIFY";
    case IE_GETRECOG: return "IE_GETRECOG";
    case IE_SETRECOG: return "IE_SETRECOG";
    case IE_GETSECURITY: return "IE_GETSECURITY";
    case IE_SETSECURITY: return "IE_SETSECURITY";
    case IE_GETSEL: return "IE_GETSEL";
    case IE_SETSEL: return "IE_SETSEL";
    case CDM_LAST: return "CDM_LAST";
    case EM_SETBIDIOPTIONS: return "EM_SETBIDIOPTIONS";
    case IE_DOCOMMAND: return "IE_DOCOMMAND";
    case MCIWNDM_NOTIFYMODE: return "MCIWNDM_NOTIFYMODE";
    case EM_GETBIDIOPTIONS: return "EM_GETBIDIOPTIONS";
    case IE_GETCOMMAND: return "IE_GETCOMMAND";
    case EM_SETTYPOGRAPHYOPTIONS: return "EM_SETTYPOGRAPHYOPTIONS";
    case IE_GETCOUNT: return "IE_GETCOUNT";
    case EM_GETTYPOGRAPHYOPTIONS: return "EM_GETTYPOGRAPHYOPTIONS";
    case IE_GETGESTURE: return "IE_GETGESTURE";
    case MCIWNDM_NOTIFYMEDIA: return "MCIWNDM_NOTIFYMEDIA";
    case EM_SETEDITSTYLE: return "EM_SETEDITSTYLE";
    case IE_GETMENU: return "IE_GETMENU";
    case EM_GETEDITSTYLE: return "EM_GETEDITSTYLE";
    case IE_GETPAINTDC: return "IE_GETPAINTDC";
    case MCIWNDM_NOTIFYERROR: return "MCIWNDM_NOTIFYERROR";
    case IE_GETPDEVENT: return "IE_GETPDEVENT";
    case IE_GETSELCOUNT: return "IE_GETSELCOUNT";
    case IE_GETSELITEMS: return "IE_GETSELITEMS";
    case IE_GETSTYLE: return "IE_GETSTYLE";
    case MCIWNDM_SETTIMEFORMATW: return "MCIWNDM_SETTIMEFORMATW";
    case EM_OUTLINE: return "EM_OUTLINE";
    case MCIWNDM_GETTIMEFORMATW: return "MCIWNDM_GETTIMEFORMATW";
    case EM_GETSCROLLPOS: return "EM_GETSCROLLPOS";
    case EM_SETSCROLLPOS: return "EM_SETSCROLLPOS";
    case EM_SETSCROLLPOS: return "EM_SETSCROLLPOS";
    case EM_SETFONTSIZE: return "EM_SETFONTSIZE";
    case EM_GETZOOM: return "EM_GETZOOM";
    case MCIWNDM_GETFILENAMEW: return "MCIWNDM_GETFILENAMEW";
    case EM_SETZOOM: return "EM_SETZOOM";
    case MCIWNDM_GETDEVICEW: return "MCIWNDM_GETDEVICEW";
    case EM_GETVIEWKIND: return "EM_GETVIEWKIND";
    case EM_SETVIEWKIND: return "EM_SETVIEWKIND";
    case EM_GETPAGE: return "EM_GETPAGE";
    case MCIWNDM_GETERRORW: return "MCIWNDM_GETERRORW";
    case EM_SETPAGE: return "EM_SETPAGE";
    case EM_GETHYPHENATEINFO: return "EM_GETHYPHENATEINFO";
    case EM_SETHYPHENATEINFO: return "EM_SETHYPHENATEINFO";
    case EM_GETPAGEROTATE: return "EM_GETPAGEROTATE";
    case EM_SETPAGEROTATE: return "EM_SETPAGEROTATE";
    case EM_GETCTFMODEBIAS: return "EM_GETCTFMODEBIAS";
    case EM_SETCTFMODEBIAS: return "EM_SETCTFMODEBIAS";
    case EM_GETCTFOPENSTATUS: return "EM_GETCTFOPENSTATUS";
    case EM_SETCTFOPENSTATUS: return "EM_SETCTFOPENSTATUS";
    case EM_GETIMECOMPTEXT: return "EM_GETIMECOMPTEXT";
    case EM_ISIME: return "EM_ISIME";
    case EM_GETIMEPROPERTY: return "EM_GETIMEPROPERTY";
    case EM_GETQUERYRTFOBJ: return "EM_GETQUERYRTFOBJ";
    case EM_SETQUERYRTFOBJ: return "EM_SETQUERYRTFOBJ";
    case FM_GETFOCUS: return "FM_GETFOCUS";
    case FM_GETDRIVEINFOA: return "FM_GETDRIVEINFOA";
    case FM_GETSELCOUNT: return "FM_GETSELCOUNT";
    case FM_GETSELCOUNTLFN: return "FM_GETSELCOUNTLFN";
    case FM_GETFILESELA: return "FM_GETFILESELA";
    case FM_GETFILESELLFNA: return "FM_GETFILESELLFNA";
    case FM_REFRESH_WINDOWS: return "FM_REFRESH_WINDOWS";
    case FM_RELOAD_EXTENSIONS: return "FM_RELOAD_EXTENSIONS";
    case FM_GETDRIVEINFOW: return "FM_GETDRIVEINFOW";
    case FM_GETFILESELW: return "FM_GETFILESELW";
    case FM_GETFILESELLFNW: return "FM_GETFILESELLFNW";
    case WLX_WM_SAS: return "WLX_WM_SAS";
    case SM_GETSELCOUNT: return "SM_GETSELCOUNT";
    case UM_GETSELCOUNT: return "UM_GETSELCOUNT";
    case WM_CPL_LAUNCH: return "WM_CPL_LAUNCH";
    case SM_GETSERVERSELA: return "SM_GETSERVERSELA";
    case UM_GETUSERSELA: return "UM_GETUSERSELA";
    case WM_CPL_LAUNCHED: return "WM_CPL_LAUNCHED";
    case SM_GETSERVERSELW: return "SM_GETSERVERSELW";
    case UM_GETUSERSELW: return "UM_GETUSERSELW";
    case SM_GETCURFOCUSA: return "SM_GETCURFOCUSA";
    case UM_GETGROUPSELA: return "UM_GETGROUPSELA";
    case SM_GETCURFOCUSW: return "SM_GETCURFOCUSW";
    case UM_GETGROUPSELW: return "UM_GETGROUPSELW";
    case SM_GETOPTIONS: return "SM_GETOPTIONS";
    case UM_GETCURFOCUSA: return "UM_GETCURFOCUSA";
    case UM_GETCURFOCUSW: return "UM_GETCURFOCUSW";
    case UM_GETOPTIONS: return "UM_GETOPTIONS";
    case UM_GETOPTIONS2: return "UM_GETOPTIONS2";
#endif

    case LVM_GETBKCOLOR: return "LVM_GETBKCOLOR";
  //case LVM_FIRST: return "LVM_FIRST"; // Alias for LVM_GETBKCOLOR
  ...
  //case LVM_SETTILEWIDTH: return "LVM_SETTILEWIDTH";
    ...
    case LVM_GETEMPTYTEXT: return "LVM_GETEMPTYTEXT";
    case LVM_GETFOOTERRECT: return "LVM_GETFOOTERRECT";
    case LVM_GETFOOTERINFO: return "LVM_GETFOOTERINFO";
    case LVM_GETFOOTERITEMRECT: return "LVM_GETFOOTERITEMRECT";
    case LVM_GETFOOTERITEM: return "LVM_GETFOOTERITEM";
    case LVM_GETITEMINDEXRECT: return "LVM_GETITEMINDEXRECT";
    case LVM_SETITEMINDEXSTATE: return "LVM_SETITEMINDEXSTATE";
    case LVM_GETNEXTITEMINDEX: return "LVM_GETNEXTITEMINDEX";
    case OCM__BASE: return "OCM__BASE";
  //case CCM_FIRST: return "CCM_FIRST"; // Alias of OCM__BASE
    case CCM_SETBKCOLOR: return "CCM_SETBKCOLOR";
    case CCM_SETCOLORSCHEME: return "CCM_SETCOLORSCHEME";
    case CCM_GETCOLORSCHEME: return "CCM_GETCOLORSCHEME";
    case CCM_GETDROPTARGET: return "CCM_GETDROPTARGET";
    case CCM_SETUNICODEFORMAT: return "CCM_SETUNICODEFORMAT";
  //case LVM_SETUNICODEFORMAT: return "LVM_SETUNICODEFORMAT"; // Alias of CCM_SETUNICODEFORMAT
    case CCM_GETUNICODEFORMAT: return "CCM_GETUNICODEFORMAT";
  //case LVM_GETUNICODEFORMAT: return "LVM_GETUNICODEFORMAT"; // Alias of LVM_GETUNICODEFORMAT
    case CCM_SETVERSION: return "CCM_SETVERSION";
    case CCM_GETVERSION: return "CCM_GETVERSION";
    case CCM_SETNOTIFYWINDOW: return "CCM_SETNOTIFYWINDOW";
    case CCM_SETWINDOWTHEME: return "CCM_SETWINDOWTHEME";
    case CCM_DPISCALE: return "CCM_DPISCALE";
  //case OCM_CTLCOLOR: return "OCM_CTLCOLOR";
    case OCM_DRAWITEM: return "OCM_DRAWITEM";
    case OCM_MEASUREITEM: return "OCM_MEASUREITEM";
    case OCM_DELETEITEM: return "OCM_DELETEITEM";
    case OCM_VKEYTOITEM: return "OCM_VKEYTOITEM";
    case OCM_CHARTOITEM: return "OCM_CHARTOITEM";
    case OCM_COMPAREITEM: return "OCM_COMPAREITEM";
    case OCM_NOTIFY: return "OCM_NOTIFY";
    case OCM_COMMAND: return "OCM_COMMAND";
    case OCM_HSCROLL: return "OCM_HSCROLL";
    case OCM_VSCROLL: return "OCM_VSCROLL";
    case OCM_CTLCOLORMSGBOX: return "OCM_CTLCOLORMSGBOX";
    case OCM_CTLCOLOREDIT: return "OCM_CTLCOLOREDIT";
    case OCM_CTLCOLORLISTBOX: return "OCM_CTLCOLORLISTBOX";
    case OCM_CTLCOLORBTN: return "OCM_CTLCOLORBTN";
    case OCM_CTLCOLORDLG: return "OCM_CTLCOLORDLG";
    case OCM_CTLCOLORSCROLLBAR: return "OCM_CTLCOLORSCROLLBAR";
    case OCM_CTLCOLORSTATIC: return "OCM_CTLCOLORSTATIC";
    case OCM_PARENTNOTIFY: return "OCM_PARENTNOTIFY";
    case WM_APP: return "WM_APP";
  //case WM_RASDIALEVENT: return "WM_RASDIALEVENT";
