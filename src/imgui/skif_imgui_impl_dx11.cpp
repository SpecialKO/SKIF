...
static void ImGui_ImplDX11_CreateFontsTexture (void)
{
  ...
  [&](UINT slot)
  {
    ...
    D3D11_SAMPLER_DESC
      ...
      sampler_desc.AddressU           = D3D11_TEXTURE_ADDRESS_WRAP; // D3D11_TEXTURE_ADDRESS_CLAMP
      sampler_desc.AddressV           = D3D11_TEXTURE_ADDRESS_WRAP; // D3D11_TEXTURE_ADDRESS_CLAMP
      sampler_desc.AddressW           = D3D11_TEXTURE_ADDRESS_WRAP; // D3D11_TEXTURE_ADDRESS_CLAMP
      sampler_desc.MipLODBias         = 0.f;
      sampler_desc.ComparisonFunc     = D3D11_COMPARISON_ALWAYS; // D3D11_COMPARISON_NEVER
               ...
               ID3D11DeviceContext *device_context )
{
  ...
  io.BackendRendererName = "skif_imgui_impl_dx11";
