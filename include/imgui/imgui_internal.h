...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    ImGuiOldColumnFlags_None                      = ImGuiOldColumnFlags_None,
    ImGuiOldColumnFlags_NoBorder                  = ImGuiOldColumnFlags_NoBorder,
    ImGuiOldColumnFlags_NoResize                  = ImGuiOldColumnFlags_NoResize,
    ImGuiOldColumnFlags_NoPreserveWidths          = ImGuiOldColumnFlags_NoPreserveWidths,
    ImGuiOldColumnFlags_NoForceWithinWindow       = ImGuiOldColumnFlags_NoForceWithinWindow,
    ImGuiOldColumnFlags_GrowParentContentsSize    = ImGuiOldColumnFlags_GrowParentContentsSize,
#endif
};
