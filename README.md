...
| `SKIF_SteamAppIDtxt=0`    | Detects and removes `steam_appid.txt` file from the working directory. Useful if the Steam client recreates the file when using the `SKIF %COMMAND` launch option. |
